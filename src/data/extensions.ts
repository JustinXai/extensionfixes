...
export const extensions: ExtensionRecord[] = [
  ...
  },
  {
    ...
    aliases: [
      ...
      'tampermonkey alternative chrome',
      'tampermonkey alternatives',
      'tampermonkey vs violentmonkey',
      'violentmonkey vs tampermonkey',
      'userscript manager chrome',
      'chrome userscript manager alternatives',
    ],
    category: 'Script Manager',
    summary:
      'Tampermonkey is one of the most widely used userscript managers for Chrome, with a large script ecosystem and broad compatibility.',
    status: 'active_mv3',
    riskLevel: 'low',
    issueSummary:
      'Tampermonkey is actively maintained as an MV3-compatible userscript manager. Users compare it with Violentmonkey for interface preferences and workflow.',
    shortAnswer:
    ...
    whatHappened: [
      'Tampermonkey was updated to support Manifest V3 and works in current Chrome.',
      'The project remains actively maintained with regular updates.',
      'Users compare it with Violentmonkey for interface preferences, resource usage, and feature trade-offs.',
      'Both Tampermonkey and Violentmonkey are legitimate, maintained options with different design goals.',
    ],
    migrationSteps: [
      'Back up your current scripts and settings.',
      'List the scripts you still actively use.',
      'Install the alternative userscript manager you want to test.',
      'Import only a few important scripts first.',
      'Review @match and @grant permissions.',
      'Test on non-sensitive websites.',
      'Remove unused or abandoned scripts.',
    ],
    safetyNotes: [
      'Tampermonkey is available from the official Chrome Web Store.',
      'Userscripts run with significant browser access — only install scripts from sources you trust.',
      'Review script permissions before installation; scripts can read and modify page content.',
      'Avoid installing scripts from random websites, mirrors, or search results.',
      'Disable or remove scripts you no longer use to reduce unnecessary browser access.',
    ],
    alternatives: [
      {
        name: 'Violentmonkey',
        slug: 'violentmonkey',
        bestFor: 'Users who prefer an open-source userscript manager with script control',
        status: 'active_mv3',
        chromeStoreUrl:
          'https://chromewebstore.google.com/detail/violentmonkey/jinjaccalgkegednnccohejagnlnfdag',
        githubUrl: 'https://github.com/violentmonkey/violentmonkey',
        pros: [
          ...
          'Supports Tampermonkey-compatible scripts',
        ],
        cons: [
          'Fewer built-in features than Tampermonkey',
          'Smaller feature set for script editing',
        ],
        note: 'Violentmonkey is a common alternative for users who prefer an open-source userscript workflow.',
      },
      {
        name: 'Browser bookmarklets',
        slug: 'browser-bookmarklets',
        bestFor: 'Users who need to run very simple personal scripts with no extension',
        status: 'active_mv3',
        pros: [
          'No extension needed',
          'Simple and lightweight',
    ...
    faqs: [
      {
        question: 'What is the best Tampermonkey alternative for Chrome?',
        answer:
          'Violentmonkey is the most common alternative for users who prefer an open-source userscript manager and lightweight interface. Tampermonkey remains widely used with a larger script ecosystem. The best option depends on whether you prioritize script compatibility, open-source tooling, or resource usage.',
      },
      {
        question: 'Is Violentmonkey a Tampermonkey alternative?',
        answer:
          'Yes. Violentmonkey is a legitimate Tampermonkey alternative. Both support the same script format (Tampermonkey-compatible scripts) and work in Chrome as MV3 extensions. The main differences are in interface design, resource usage, and feature set — Tampermonkey has more built-in features while Violentmonkey is more lightweight and fully open source.',
      },
      {
        question: 'Is Tampermonkey still available for Chrome?',
        answer:
          'Yes. Tampermonkey is actively maintained and available as an MV3 extension in the Chrome Web Store. It works in Chrome 138 and later versions. Both Tampermonkey and Violentmonkey have updated to support Manifest V3.',
      },
      {
        question: 'Are userscript managers safe?',
        answer:
      ...
      },
      {
        question: 'Should I install scripts from random websites?',
        answer:
          'No. Installing userscripts from unknown or random sources can expose your browsing data and accounts. Only install scripts from well-known repositories like Greasy Fork or OpenUserJS, or scripts whose code you have reviewed personally. Avoid scripts from websites you do not recognize or that appear in search results as standalone downloads.',
      },
      {
        question: 'How do I migrate from Tampermonkey to Violentmonkey?',
        answer:
          'Export your scripts from Tampermonkey (Options > Scripts > Export). Install Violentmonkey from the official Chrome Web Store. Import the exported scripts into Violentmonkey and verify each one works on the sites you need. Review @match and @grant permissions before enabling scripts. Remove any scripts you no longer actively use.',
      },
      {
        question: 'What is the recommended way to test a userscript manager?',
        answer:
          'Review the script code before installing it — look at what URLs it will run on and what permissions it requests. Install scripts one at a time and test on a non-critical site first. Use the userscript manager to temporarily disable scripts you are not actively using. If a script requests permissions that seem excessive for its stated purpose, do not install it.',
      },
    ],
    sources: [
      {
        ...
        sourceType: 'chrome-web-store',
        reliability: 'primary',
        supports: 'Tampermonkey MV3 availability and Chrome status',
      },
      {
        ...
        reliability: 'primary',
        supports: 'Tampermonkey official information and documentation',
      },
      {
        title: 'Violentmonkey Chrome Web Store',
        url: 'https://chromewebstore.google.com/detail/violentmonkey/jinjaccalgkegednnccohejagnlnfdag',
        ...
        sourceType: 'chrome-web-store',
        reliability: 'primary',
        supports: 'Violentmonkey MV3 availability and alternative status',
      },
      {
        title: 'Violentmonkey GitHub Repository',
        url: 'https://github.com/violentmonkey/violentmonkey',
        ...
        sourceType: 'github',
        reliability: 'secondary',
        supports: 'Violentmonkey open-source code and development status',
      },
    ],
    lastUpdated: '2026-05-22',
    keyTakeaways: [
      'Tampermonkey remains a widely used userscript manager for Chrome.',
      'Violentmonkey is a common alternative for users who prefer an open-source userscript workflow.',
      'Userscript managers can run code on pages you visit, so script trust matters more than brand alone.',
      'Avoid random userscript mirrors and unknown script bundles.',
      'Test important scripts one by one before switching managers.',
      'The best option depends on compatibility, openness, permissions, and sync needs.',
    ],
    currentStatus: [
      { label: 'Tampermonkey', value: 'Widely used userscript manager for Chrome — active MV3 extension', variant: 'good' },
      { label: 'Main alternative', value: 'Violentmonkey', variant: 'neutral' },
      { label: 'Main risk', value: 'Userscripts can affect pages you visit — script trust matters', variant: 'neutral' },
      { label: 'Best practice', value: 'Install scripts only from trusted sources and review permissions', variant: 'neutral' },
      { label: 'Last reviewed', value: 'May 22, 2026', variant: 'neutral' },
    ],
    comparisonTable: [
      {
        option: 'Tampermonkey',
        bestFor: 'Broad userscript compatibility',
        mv3Support: 'Yes',
        cost: 'Free',
        openSource: 'Partial',
        setupDifficulty: 'Easy',
        mainTradeoff: 'Some users prefer more open-source tooling',
      },
      {
        option: 'Violentmonkey',
        bestFor: 'Open-source userscript management',
        mv3Support: 'Yes',
        cost: 'Free',
        openSource: 'Yes',
        setupDifficulty: 'Easy',
        mainTradeoff: 'Compatibility can vary by script and browser behavior',
      },
      {
        option: 'Browser bookmarks/snippets',
        bestFor: 'Very simple personal scripts',
        mv3Support: 'N/A',
        cost: 'Free',
        openSource: 'N/A',
        setupDifficulty: 'Very Easy',
        mainTradeoff: 'Not a full userscript manager',
      },
      {
        option: 'Random script mirrors',
        bestFor: 'Not recommended',
        mv3Support: 'Avoid',
        cost: 'N/A',
        openSource: 'N/A',
        setupDifficulty: 'N/A',
        mainTradeoff: 'Malware, account, and privacy risk',
      },
    ],
    decisionGuide: [
      {
        choose: 'Tampermonkey',
        when: 'You need broad userscript compatibility and a familiar workflow with a large script ecosystem.',
      },
      {
        choose: 'Violentmonkey',
        when: 'You prefer open-source userscript management and want more transparent control over imported scripts.',
      },
      {
        choose: 'Browser bookmarks/snippets',
        when: 'You only need to run very simple personal scripts without an extension.',
      },
    ],
    commonFailedFixes: [
      {
        tried: 'Install scripts from random mirrors',
        whyItFails: 'Unknown scripts can read or modify pages you visit and may contain malicious code.',
        saferAlternative: 'Use trusted script sources and inspect script permissions.',
      },
      {
        tried: 'Switch userscript managers without testing scripts',
        whyItFails: 'Some scripts depend on manager-specific behavior.',
        saferAlternative: 'Test important scripts one by one before fully switching.',
      },
      {
        tried: 'Import all old scripts at once',
        whyItFails: 'Old scripts may be broken, abandoned, or unsafe on modern websites.',
        saferAlternative: 'Import only scripts you still use.',
      },
      {
        tried: 'Ignore @match and @grant permissions',
        whyItFails: 'Permissions control where and how scripts run.',
        saferAlternative: 'Review @match, @grant, and external resource usage before enabling.',
      },
      {
        tried: 'Keep unused scripts enabled forever',
        whyItFails: 'Old scripts can break websites or create unnecessary risk.',
        saferAlternative: 'Disable or remove scripts you no longer use.',
      },
    ],
  },
  {
