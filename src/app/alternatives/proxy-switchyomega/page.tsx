...
export async function generateStaticParams() {
  return [{ slug: 'proxy-switchyomega' }];
}
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Proxy SwitchyOmega not working in Chrome? Compare MV3-compatible proxy switcher alternatives including ZeroOmega and FoxyProxy, with migration steps.',
    ...
    twitter: {
      ...
      title: 'Best Proxy SwitchyOmega Alternatives for Chrome MV3',
      description:
        'Proxy SwitchyOmega not working in Chrome? Compare MV3-compatible proxy switcher alternatives including ZeroOmega and FoxyProxy.',
    },
  };
}
...
export default async function ProxySwitchyOmegaPage({ params }: PageProps) {
  const { slug } = await params;
  const extension = getExtensionBySlug(slug);
          ...
          <section className="mb-10" aria-labelledby="related-resources-heading">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <p className="mt-1 text-sm text-slate-500">Specific steps for the SwitchyOmega migration</p>
              </Link>
            </div>
          </section>
